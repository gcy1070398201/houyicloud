 ...
 */
package com.hlsk.commonsdk.core;
...
public interface RouterHub {
    ...
    String MINE = "/mine";//我的 组件
    String HOMEPAGE = "/homepage";//首页 组件
    String CONNECTION = "/connection";//人脉 组件
    String DISCOVER = "/discover";//发现（商机） 组件
     ...
     * 首页分组
     */
    String HOMEPAGE_INFO_SERVICE = HOMEPAGE + SERVICE + "/HomePageInfoService";
    String HOMEPAGE_MAIN_ACTIVITY = HOMEPAGE + "/HomePageActivity";
    String HOMEPAGE_MAIN_FRAGMENT = HOMEPAGE + "/HomePageFragment";

    /**
     * 人脉分组
     */
    String CONNECTION_INFO_SERVICE = CONNECTION + SERVICE + "/ConnectionInfoService";
    String CONNECTION_MAIN_ACTIVITY = CONNECTION + "/ConnectionActivity";
    String CONNECTION_MAIN_FRAGMENT = CONNECTION + "/ConnectionFragment";

    /**
     * 发现（商机）分组
     */
    String DISCOVER_INFO_SERVICE = DISCOVER + SERVICE + "/DiscoverInfoService";
    String DISCOVER_MAIN_ACTIVITY = DISCOVER + "/DiscoverActivity";
